...
/*   Updated: 2025/03/18 13:22:46 by abouclie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
 * This function attempts to move the player one position upwards (towards the top) on the map. 
 * It first calculates the next position based on the player's current position. 
 * If the next position is not a wall, the player is moved:
 * - If the next position is not the exit, the player moves to the floor and the move is processed.
 * - If the next position is the exit, the player moves to the exit and the win condition is triggered.
 *
 ...
 *
 * This function attempts to move the player one position to the left on the map. 
 * It calculates the next position based on the player's current position. 
 * If the next position is not a wall, the player is moved:
 * - If the next position is not the exit, the player moves to the floor and the move is processed.
 * - If the next position is the exit, the player moves to the exit and the win condition is triggered.
 *
 ...
 *
 * This function attempts to move the player one position to the right on the map. 
 * It calculates the next position based on the player's current position. 
 * If the next position is not a wall, the player is moved:
 * - If the next position is not the exit, the player moves to the floor and the move is processed.
 * - If the next position is the exit, the player moves to the exit and the win condition is triggered.
 ...
 *
 * This function attempts to move the player one position to the downwards on the map. 
 * It calculates the next position based on the player's current position. 
 * If the next position is not a wall, the player is moved:
 * - If the next position is not the exit, the player moves to the floor and the move is processed.
 * - If the next position is the exit, the player moves to the exit and the win condition is triggered.
 ...
 *
 * This function is called when a key is pressed. It checks the keycode and performs the corresponding action:
 ...
 *
 * The player's current position is used to calculate the next position based on the key pressed.
 * If the move is valid, the player is moved to the new position. If the player reaches the exit,
