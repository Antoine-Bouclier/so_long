...
/*   Updated: 2025/03/18 13:24:08 by abouclie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
 * This function is called when the user attempts to close the window (e.g., by pressing the close button). 
 * It frees all memory allocated for the game and its resources before exiting the program. 
